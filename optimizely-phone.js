(function () {
  'use strict';
  /* optimizely-phone.js — copy of optimizely-new.js for phone-eligibility experiment; use one of optimizely.js / optimizely-new.js / optimizely-phone.js per variation, not multiple on the same page. */
  ...
  function processDataLayerEvent(eventObj) {
    ...
    if (eventObj.event === 'webform_submission_completed') {
      ...
      if (isEligible(eventObj.answers || {})) {
        ...
        startEligibleQualificationPipeline(postcode, eventObj, 'webform_submission_completed', answers);
      } else {
    ...
    if (eventObj.event === 'thankYouPageReached') {
      ...
      if (isEligible(eventObj.answers || {})) {
        ...
        window.__solarOptlySlotCheckInFlight = true;
        startEligibleQualificationPipeline(postcode, eventObj, 'thankYouPageReached', typrAnswers);
